...
The project is currently under active development. There are now pre-built binaries
for all major platforms (Windows x86-64, Linux x86-64, Mac ARM).

For other platforms `uv install` should work.
